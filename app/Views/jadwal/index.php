        ...
        <div class="card">
            <div class="card-header d-flex">
                ...
                <div class="card-tools ms-auto">
                    <a href="<?= base_url('jadwalUjian/input') ?>" class="btn btn-secondary btn-sm">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                            ...
                            <td><?= $d['token'] ?></td>
                            <td>
                                <a href="<?= base_url('jadwalUjian/edit/' . $d['id_jadwal_ujian']) ?>" class="btn btn-warning btn-sm my-2"><i class="icon-pencil"></i> Edit</a>

                                <a href="#" class="btn btn-danger btn-sm" id="btn-delete" data-id="<?= $d['id_jadwal_ujian'] ?>"><i class="icon-trash"></i> Hapus</a>
                            </td>
                        </tr>
                      <?php } ?>
                    </tbody>
