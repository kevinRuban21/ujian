                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <select name="jenis_ujian" class="form-control">
                            <option value="<?= $mapel['jenis_ujian'] ?>"><?= $mapel['jenis_ujian'] ?></option>
                            <option value="">-</option>
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_jadwal" class="form-control">
                            <option value="<?= $mapel['id_jadwal'] ?>"><?= $mapel['jurusan'] ?> | <?= $mapel['kelas'] ?> | <?= $mapel['mapel'] ?></option>
                            <option value="">-</option>
                            <?php
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_ujian" value="<?= $mapel['tgl_ujian'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Waktu Mulai</label>
                        <input type="time" name="waktu_mulai" value="<?= $mapel['waktu_mulai'] ?>" class="form-control">
                    <div class="form-group">
                        <label>Waktu Selesai</label>
                        <input type="time" name="waktu_selesai" value="<?= $mapel['waktu_selesai'] ?>" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Token</label>
                        <input name="token" class="form-control" value="<?= $mapel['token'] ?>" placeholder="Token">
                    </div>
        ...
        <script>
          $(document).ready(function() {
            $('#input_jadwal_form').submit(function(e) {
                e.preventDefault();
                $.ajax({
                    url: '<?= base_url('jadwalUjian/UpdateData/' . $mapel['id_jadwal_ujian']) ?>',
                    type: 'POST',
                    data: $(this).serialize(),
